...
class PhuzzyGameEngine {
    constructor(config = {}) {
        ...
        this.voicePlayer = null; // Will be set by audio integration
        this.audioEngine = null; // Will be set by audio integration
    ...
    async startGame() {
        ...
        // DON'T load first scenario yet - wait for audio system to be ready
    }
    ...
    async startFirstScenario() {
        ...
        // NOW load the first scenario with audio system ready
